...
def main(current_date = datetime.datetime.now().date()):
  ...
  tracks = Tracks.read(f"/home/simplon/airflow/spotify_playlist/spotify_playlist/tracks_{current_date.isoformat()}.csv")
  ...
  Artists.write(artists, f"/home/simplon/airflow/spotify_playlist/spotify_playlist/artists_{current_date.isoformat()}.csv")
