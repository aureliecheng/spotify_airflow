...
os.environ['SPOTIFY_CLIENT_ID'] = 'b169449660ba4fcda1b14088ac05c230'
os.environ['SPOTIFY_CLIENT_SECRET'] = '73b8bc3198ed4fbfbe0952c00d5a4837'
...
class Spotify:
    ...
    def __init__(self, client_id=None, client_secret=None) -> None:
        self.client_id = 'b169449660ba4fcda1b14088ac05c230' #os.getenv("SPOTIFY_CLIENT_ID", client_id)
        self.client_secret = '73b8bc3198ed4fbfbe0952c00d5a4837'#os.getenv("SPOTIFY_CLIENT_SECRET", client_secret)
